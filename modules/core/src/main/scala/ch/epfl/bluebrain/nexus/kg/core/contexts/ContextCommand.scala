...
object ContextCommand {
  ...
  /**
    ...
    */
  final case class CreateContext(id: ContextId, value: Json) extends ContextCommand
  ...
  /**
    ...
    */
  final case class UpdateContext(id: ContextId, rev: Long, value: Json) extends ContextCommand
  ...
  /**
    ...
    * @param rev the last known revision of the context
    */
  final case class PublishContext(id: ContextId, rev: Long) extends ContextCommand
  ...
  /**
    ...
    * @param rev the last known revision of the context
    */
  final case class DeprecateContext(id: ContextId, rev: Long) extends ContextCommand
