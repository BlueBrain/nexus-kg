...
import ch.epfl.bluebrain.nexus.commons.shacl.validator.ValidationReport
...
object Rejection {
  ...
  /**
    * Signals that the SHACL validation failed.
    *
    * @param validationReport report generated by SHACL validator
    */
  final case class ShaclValidationError(validationReport: ValidationReport)
      extends Rejection(s"SHACL validation failed: $validationReport")
}
