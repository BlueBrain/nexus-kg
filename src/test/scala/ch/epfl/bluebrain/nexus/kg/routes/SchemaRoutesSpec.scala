...
class SchemaRoutesSpec
  ...
  // format: off
  private val routes = Routes(resources, mock[Resolvers[Task]], mock[Views[Task]], mock[Storages[Task]], schemas, mock[Files[Task]], tagsRes, mock[ProjectViewCoordinator[Task]])
  // format: on
