...
lazy val sourcingCore         = nexusDep("sourcing-core", sourcingVersion)
lazy val sourcingAkka         = nexusDep("sourcing-akka", sourcingVersion)
lazy val sourcingMem          = nexusDep("sourcing-mem", sourcingVersion)
lazy val commonsSchemas       = nexusDep("commons-schemas", commonsVersion)
lazy val commonsTest          = nexusDep("commons-test", commonsVersion)
lazy val serviceKamon         = nexusDep("service-kamon", serviceVersion)
lazy val serviceHttp          = nexusDep("service-http", serviceVersion)
lazy val serviceIndexing      = nexusDep("service-indexing", serviceVersion)
lazy val serviceSerialization = nexusDep("service-serialization", serviceVersion)
