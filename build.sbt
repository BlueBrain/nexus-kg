...
lazy val tests = project
  ...
  .dependsOn(core % "test->test;compile->compile",
             service % "test->test;compile->compile")
  .settings(common)
  .settings(
    name := "kg-tests",
    moduleName := "kg-tests",
...
lazy val root = project
  ...
  .settings(
    ...
    licenses := Seq(
      ("Apache 2.0",
       new URL("https://github.com/BlueBrain/nexus-kg/blob/master/LICENSE")))
  )
...
addCommandAlias(
  "review",
  ";clean;coverage;scapegoat;test;coverageReport;coverageAggregate")
